...
2. `update-agent-instruction.md` - workshop/2-ai-bpr/build/build.md を読み込み、agent_processor.py の AGENT_INSTRUCTION を更新して cdk deploy で再デプロイ
3. `update-web-ui-title.md` - workshop/2-ai-bpr/build/build.md を読み込み、WEB UI のタイトルを更新して cdk deploy で再デプロイ
...
- `workshop/2-ai-bpr` パワーで `workshop/2-ai-bpr/build/build.md` が生成済み
